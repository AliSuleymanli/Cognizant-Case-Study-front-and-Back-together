...
export class WarehouseApp extends MobxLitElement {
  ...
  render() {
    return html`
      ...
      <div class="shopping-card" @click="${this.showcard}" title="There are ${this.countOfItemsInTheCard} items in the card">
        <div class="count">${this.countOfItemsInTheCard}</div>
